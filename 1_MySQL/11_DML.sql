...
-- emp_dept 테이블에 employee에서 부서코드가 D1인 직원의 사번 이름 부서코드 입사일 추가
...
-- 모든 사원의 급여를 기존 급여에서 10프로 인상한 금액(salary * 1.1) 으로 변경
UPDATE emp_salary
...
-- 아시아 지역에 근무한느 직원들의 보너스를 0.3으로 변경 (변경사항 emp_salary)
