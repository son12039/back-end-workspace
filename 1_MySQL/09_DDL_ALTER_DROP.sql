...
/*
	1-2. 컬럼 수정 (MODIFY)
    - 자료형 변경 : ALTER TALBE 테이블명 MODIFY 컬럼명 변경할 자료형;
...
ALTER TABLE dept_copy MODIFY dept_id TEXT(3);
...
/*
    ...
    - ADD [CONSTRAINT 제약조건명] FOREIGN KEY(컬럼명) REFERENTCES 테이블명(컬럼명);
...
ALTER TABLE dept_copy ADD unique key(dept_title);

/*
	2-2. 제약조건 삭제
    - NOT NULL : ALTER TABLE 테이블명 MODIFY 컬럼명 NULL;
    - 나머지 : ALTER TABLE 테이블명 DROP CONSTARINT 제약조건명:
*/
ALTER TABLE dept_copy DROP CONSTRAINT dept_copy;
