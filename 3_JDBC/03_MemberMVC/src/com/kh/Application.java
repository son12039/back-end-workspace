...
public class Application {
	...
	public void signUp() throws SQLException {
		...
		System.out.println(mc.signUp(id, password, name) ? "성공적으로 회원가입 완료하였습니다." :
	...
	public void changePassword() throws SQLException {
		...
		System.out.println(mc.changePassword(id, password, newPassword)?
				"비밀번호 변경에 성공했습니다." :"비밀번호 변경에 실패했습니다. 다시 입력해주세요.");
	...
	public void changeName() throws SQLException {
		...
		String name = mc.login(id, password);
		if(name!=null) {
			System.out.println("현재 설정된 이름 : " + name + "입니다");
			System.out.print("변경할 이름 입력 : ");
			String newName = sc.nextLine();
			mc.changeName(id, password, newName);
