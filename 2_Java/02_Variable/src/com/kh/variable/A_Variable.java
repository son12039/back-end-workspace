...
//		variable.variableTest();
	...
	public void printValue() {
		...
		System.out.println(r * r * pi); //syso +ctrl + 스페이스바 -> Enter!
	...
	public void variableTest() {
		 ...
		 * 
		 * 	 자료형 변수명;
		 * 	 - 자료형 : 어떤 값을 저장할지, 어떤 크기의 메모리를 할당받을지에 대한정보
...
//		ch = 'ab'; 에러 발생! --> 주석 단축키 : ctrl + /
		...
		// 3. 정수형
		byte bNum = 1; // 1byte(=8bit)(-2^7 ~2^7-1) 256 = 2^8
//		bNum = 128; 에러 발생! -> 오버플로우(Overflow)
		short sNum = 128; // 2byte(=16but)
		int iNum = 922337283; // 4byte (기본)
		long lNum = 922337283458L; // 8byte - 숫자 뒤에 L(1)을 입력
