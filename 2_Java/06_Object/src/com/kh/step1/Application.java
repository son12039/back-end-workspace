...
public class Application {
	 ...
	 * - 클래스는 필드(Field), 메서드, 생성자(Constructor)가 정의
	...
	public static void main(String[] args) {
		 ...
		 * */
		System.out.println("TV 상태 : " + (tv.power ? "켜짐" : "꺼짐")); // Tv가 꺼진 상태
		tv.power();
		System.out.println("TV 상태 : " + (tv.power ? "켜짐" : "꺼짐"));
