...
public class A_String {
	...
	public void method2() {
		...
		String str5 = str.replaceFirst("l", "c");
		System.out.println("5 replace : " + str5);
		
		// 6. toUpperCase() / toLowerCase() : String
		//    문자열을 모두 새/소문자로 변경한 새로운 문자열을 생성해서 리턴
	...
	public void method3() {
		...
		// IPA avaJ
		System.out.println(sb2.reverse().delete(0, 7).insert(0, "IPA"));
	 ...
	 * - 객체 생성이 생성자로 전달받은 문자열을 구분자를 이용하여 분리
